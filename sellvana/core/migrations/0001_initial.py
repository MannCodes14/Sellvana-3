# Generated by Django 5.1.3 on 2025-01-09 15:19
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('city', models.CharField(blank=True, default='Virar', max_length=100, null=True)),
                ...
                ('pincode', models.CharField(blank=True, default='401303', max_length=100, null=True)),
                ('phone', models.CharField(blank=True, default='1234567890', max_length=100, null=True)),
                ('email', models.EmailField(blank=True, default='email@gmail.com', max_length=100, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, default='product.jpg', null=True, upload_to=core.models.user_directory_path)),
                ...
                ('user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL)),
                ('tag', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='core.tags')),
            ],
        ),
        migrations.CreateModel(
            name='ProductImages',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image', models.ImageField(blank=True, default='product.jpg', null=True, upload_to='product-images')),
                ('date', models.DateTimeField(auto_now_add=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, default='vendor.jpg', null=True, upload_to=core.models.user_directory_path)),
                ('description', models.TextField(blank=True, default='I am amazing vendor', null=True)),
                ('address', models.TextField(default='123 virar west', max_length=100)),
